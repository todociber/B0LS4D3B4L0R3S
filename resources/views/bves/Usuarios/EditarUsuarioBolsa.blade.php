                                                        ...
                                                        <div class="box box-primary">
                                                            ...
                                                            <div class="box-body">
                                                                <div class="content">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <form method="POST" action="http://localhost:8000/UsuarioBolsa" accept-charset="UTF-8" id="form" role="form"><input name="_token" type="hidden" value="p2Mh0xu03SINzn4WbjXpSa6ef3Tk7kDg61ARhf22">
                                                                ...
                                                                <div class="box-footer">
                                                                    <input class="btn btn-primary btn-flat ladda-button" id="btnSubmit" onclick="waitingDialog.show('Procesando... ',{ progressType: 'info'})" type="submit" value="Registrar Usuario">
                                                                </div>
