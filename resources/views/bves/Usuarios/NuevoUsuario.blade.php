                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="content">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form accept-charset="UTF-8" id="form" role="form"><input name="_token"
                                                                                                          type="hidden"
                                                                                                          value="j7hLFU5zEyeMZ0lRC0KNIJMlhwifGFwxaYYmfEmT">
                                                    <div class="form-group">
                                                        <label for="Nombre">Nombre</label>
                                                        <input class="form-control"
                                                               placeholder="Ingresa el nombre del usuario" name="nombre"
                                                               type="text">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control"
                                                               placeholder="Ingresa el correo institucional del usuario"
                                    ...
                                    <div class="box-footer">
                                        <input class="btn btn-primary btn-flat ladda-button" id="btnSubmit"
