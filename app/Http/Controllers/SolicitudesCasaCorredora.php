...
class SolicitudesCasaCorredora extends Controller
{
    ...
    public function index()
    {
        ...
        return view('CasaCorredora.SolicitudesAfiliacion.MostrarAfiliaciones');
    }
    ...
    public function Procesando()
    {
        ...
        return view('CasaCorredora.SolicitudesAfiliacion.MostrarAfiliacionesEnProceso', compact('solicitudes'));
    }
